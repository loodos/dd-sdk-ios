...
class RUMForegroundSessionTimeOutInForegroundTests: XCTestCase {
    ...
    func testGivenTimedOutSessionWithApplicationLaunchView_whenEventsAreTracked() throws {
        ...
        for given in [given1, given2] {
            ...
            for when in [when1, when2, when3] {
                ...
                XCTAssertEqual(session2.sessionStartDate, processLaunchDate + dt1 + dt2 + sessionTimeoutDuration + dt3, accuracy: accuracy)
